...
namespace Excel.TemplateEngine.Tests.ObjectPrintingTests
{
    ...
    public class ObjectPropertiesExtractorTests
    {
        ...
        {
            const string valueDesñription = "Value::Bs[].Cs[].S";

            var child = ObjectPropertiesExtractor.ExtractChildObject(model, ExcelTemplatePath.FromRawExpression(valueDesñription));
